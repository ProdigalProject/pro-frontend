...
class SearchUtility(User):
    ...
    @staticmethod
    def search_by_sector(sector_symbol):
        """
    ...
    def getTickerByName(self, search_name):
        ...
        print(search_name)
        try:
            company_ticker = NasdaqCompanies.objects.get(name
                                                         =search_name).symbol
        except NasdaqCompanies.DoesNotExist:  # ticker not in company list
            return None
...
class NasdaqCompaniesTestCase(TestCase):
    def setUp(self):
        comp_obj = NasdaqCompanies(symbol = "TEST", name = "Test name Inc."
                                   , sector = "Test")
        comp_obj.save()
...
class UserTestCase(TestCase):
    def setUp(self):
        self.test_user = User(username="test", email="test8888@gmail.com",
                              gender="male", password="1234", salt="4321")
        self.test_company = NasdaqCompanies(symbol="AAPL", name="Apple Inc.",
                                            sector="Test",companyid="123")
        self.test_company_2 = NasdaqCompanies(symbol="AMZN", name="Amazon Inc."
    ...
    def test_create_user(self):
        assert self.test_user.create_user("test","test@gmail.com","male",
                                          "1234") == 1
        assert self.test_user.create_user("testab", "test235@gmail.com"
                                          , "male", "1234") == 0
